...
/**
 * Implementation of {@link UiSettingsEntry} for paths ({@link JTextField} and {@link JButton})
 * */
public class UiPathSettingsEntry extends UiSettingsEntry<JPanel, String> {
     ...
     * */
    public UiPathSettingsEntry(String label, JPanel value) {
        super(label, value);
